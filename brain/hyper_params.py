...
EPISODES_NUM = 3                       # Number of episodes in the simulation
...
HARD_UPDATE_N = 2                       # Hard update every N episodes
...
LSTM = SHARE_STATE and False            # Whether we want to use an LSTM NN as an encoder for the neighbor's shared state.
